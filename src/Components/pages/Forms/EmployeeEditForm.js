    ...
    >
       {({values,
          ...
          <Row className='d-flex flex-row justify-content-between align-items-center mt-2'>
              <Col className='d-flex justify-content-start align-items-center'><AiOutlineArrowLeft onClick={handleCancel} size={25} className='m-1 pointer'/><h4>Edit Employee Details</h4></Col>
              <Col className='d-sm-none d-none d-md-none d-lg-flex d-xxl-flex d-xl-flex flex-row justify-content-end align-items-center'>
              <Button className='m-1' variant='secondary' onClick={handleCancel}>Cancel</Button>
              <Button className='m-1' type='button' disabled={isSubmitting} onClick={ (firstName!==''&& lastName!==''&& userName!==''&& email!== ''&& password!== ''&& confirmPassword!== ''&& employeeId!== ''&& joiningDate!== ''&& mobile!== ''&& company!==''&& department!==''&& designation!=='') ? handleAddData : handleSubmit}>Update</Button>
              </Col>
          </Row>
          ...
          <Col className='m-1 p-4 d-flex  flex-wrap flex-column shadow rounded'>
            ...
            <Form.Group className='' >
              ...
              <Form.Control name='firstName' className={`form-control ${touched.firstName && errors.firstName ? "is-invalid" : ""}`} onChange={(e) => {setFirstName(e.target.value);handleChange(e); }} onBlur={handleBlur}></Form.Control>
            ...
            <Form.Group className='' >
              ...
              <Form.Control name='lastName' className={`form-control ${touched.lastName && errors.lastName ? "is-invalid" : ""}`} onChange={(e) => {setLastName(e.target.value);handleChange(e); }} onBlur={handleBlur}></Form.Control>
            ...
            <Form.Group className='' >
              ...
              <Form.Control name='userName' className={`form-control ${touched.userName && errors.userName ? "is-invalid" : ""}`} onChange={(e) => {setUserName(e.target.value=`${firstName+" "+lastName}`);handleChange(e); }} onBlur={handleBlur}></Form.Control>
            ...
            <Form.Group className='' >
              ...
              <Form.Control name='email' className={`form-control ${touched.email && errors.email ? "is-invalid" : ""}`} onChange={(e) => {setEmail(e.target.value);handleChange(e); }} onBlur={handleBlur}></Form.Control>
            ...
            <Form.Group className='' >
              ...
              <Form.Control name='password' className={`form-control ${touched.password && errors.password ? "is-invalid" : ""}`} onChange={(e) => {setPassword(e.target.value);handleChange(e); }} onBlur={handleBlur}></Form.Control>
            ...
            <Form.Group className='' >
              ...
              <Form.Control name='confirmPassword' className={`form-control ${touched.confirmPassword && errors.confirmPassword ? "is-invalid" : ""}`} onChange={(e) => {setConfirmPassword(e.target.value);handleChange(e); }} onBlur={handleBlur}></Form.Control>
            ...
            <Form.Group>
              ...
              <Form.Select name='company' className={`form-control ${touched.company && errors.company ? "is-invalid" : ""}`} onChange={(e) => {setCompany(e.target.value);handleChange(e); }} onBlur={handleBlur}>
                ...
                <option value="pqr Technologies">pqr Technologies</option>
              </Form.Select>
