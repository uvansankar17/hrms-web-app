        ...
        >
          {({values,
            ...
            <Row className='d-flex flex-row justify-content-between align-items-center'>
                <Col className='d-flex justify-content-start align-items-center'><AiOutlineArrowLeft onClick={handleCancel} size={25} className='m-1 pointer'/><h4>Edit Promotion</h4>
                </Col>
                <Col className='d-sm-none d-none d-md-none d-lg-flex d-xxl-flex d-xl-flex flex-row justify-content-end align-items-center'>
                <Button className='m-1' variant='secondary' onClick={handleCancel}>Cancel</Button>
                <Button className='m-1' type='button' disabled={isSubmitting} onClick={(promotionFor !==''&& promotionFrom !== ''&& promotionTo !== ''&& promotionDate !== '') ? handleAddData : handleSubmit}>Update</Button>
                </Col>
            </Row>
          ...
          <Form.Label>Promotion For*</Form.Label>
              <Form.Control name='promotionFor' className={`form-control ${touched.promotionFor && errors.promotionFor ? "is-invalid" : ""}`} onChange={(e) => {setPromotionFor(e.target.value);handleChange(e); }} onBlur={handleBlur}></Form.Control>
          ...
          <Col className='m-2'>
              <Form.Group>
                  ...
                  <Form.Control name='promotionDate' type='date'className={`form-control ${touched.promotionDate && errors.promotionDate ? "is-invalid" : ""}`} onChange={(e) => {setPromotionDate(e.target.value);handleChange(e); }} onBlur={handleBlur}></Form.Control>
              ...
              <Form.Label>Promotion From*</Form.Label>
                  <Form.Select name='promotionFrom' className={`form-control ${touched.promotionFrom && errors.promotionFrom ? "is-invalid" : ""}`} onChange={(e) => {setPromotionFrom(e.target.value);handleChange(e); }} onBlur={handleBlur}>
              ...
              <Form.Label>Promotion To*</Form.Label>
                  <Form.Select name='promotionTo' className={`form-control ${touched.promotionTo && errors.promotionTo ? "is-invalid" : ""}`} onChange={(e) => {setPromotionTo(e.target.value);handleChange(e); }} onBlur={handleBlur}>
                    <option disabled selected>----select----</option>
                    <option value={"Web Developer"}>Web Developer</option>
                    <option value={"FrontEnd Developer"}>FrontEnd Developer</option>
                  </Form.Select>
