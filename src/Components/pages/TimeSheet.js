 ...
 const naviagte = useNavigate();
  ...
  return (
    <div>
      <Container fluid>
     <Row>
     <Header ONCLICK={handleShow} HEADING="Time Sheet" BUTTON_NAME="Add Work Time"/>
      </Row>
      <Row className=''>
      <BasicTable COLUMNS={COLUMNS} MOCK_DATA={TIMESHEET_DATA} />
    </Row>
  </Container>
  <DeleteModel DELETESTATE={deleteShow} ONCLICK={deleteHandleClose} DESCRIPTION="Time Sheet" DELETETITLE="Day"/>
