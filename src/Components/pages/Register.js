    ...
    >
      {({values,
        ...
        <Form.Group>
            ...
            <Form.Group>
              ...
              <Form.Control
                ...
                className={`form-control ${touched.confirmPassword && errors.confirmPassword ? "is-invalid" : ""}`} onChange={(e)=>{setConfirmPassword(e.target.value);handleChange(e);}} onBlur={handleBlur} 
              ></Form.Control>
        ...
        <Button
              ...
              type='submit' disabled={isSubmitting} onClick={email !==''&& password !== '' && confirmPassword !== '' ? handleRegister : handleSubmit  }
            >
              Register
            </Button>
            <Row className="m-4">
              <p className="text-center">
                ...
                <Link className="m-1" style={{ textDecoration: "none" }} to={"/"}>
                  Login
                </Link>
              </p>
            </Row>
